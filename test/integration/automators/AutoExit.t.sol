...
contract AutoExitTest is AutomatorIntegrationTestBase {
    ...
    function testRangesAndActions() external { //@audit => NO
    ...
    function testDirectSendNFT() external { //@audit-ok
        vm.prank(TEST_NFT_ACCOUNT);
    ...
    function testSetTWAPSeconds() external { //@audit-ok
    ...
    function testSetMaxTWAPTickDifference() external { //@audit-ok
    ...
    function testSetOperator() external { //ok
    ...
    function testValidSetConfig() external { //No
        vm.prank(TEST_NFT_ACCOUNT);
    ...
    function testRunWithoutConfig() external { //ok
        vm.prank(TEST_NFT_ACCOUNT);
