...
contract AutoRangeTest is AutomatorIntegrationTestBase {
    ...
    function testAdjustWithoutConfig() external { //@audit
        vm.prank(TEST_NFT_ACCOUNT);
    ...
    function testAdjustNotAdjustable() external { //@audit
        vm.prank(TEST_NFT_2_ACCOUNT);
        NPM.setApprovalForAll(address(autoRange), true);
    ...
    function testAdjustOutOfRange() external { //@audit
        vm.prank(TEST_NFT_2_ACCOUNT);
        NPM.setApprovalForAll(address(autoRange), true);
    ...
    function testAdjustWithTooLargeSwap() external { //@audit
        vm.prank(TEST_NFT_2_ACCOUNT);
        NPM.setApprovalForAll(address(autoRange), true);
    ...
    function testDoubleAdjust() external { //@audit
        vm.prank(TEST_NFT_2_ACCOUNT);
        NPM.setApprovalForAll(address(autoRange), true);
